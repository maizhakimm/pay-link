  ...
  return (
    <main className="min-h-screen bg-white p-6">
      <div className="mx-auto max-w-md rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
        ...
        <p className="mt-2 text-sm text-slate-600">Daftar dan jual menggunakan BayarLink dan senaraikan produk di Marketplace komuniti dan kawasan anda. Buat masa ini hanya produk berasaskan makanan dan masakan.</p>
