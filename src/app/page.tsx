              ...
              <div className="overflow-hidden rounded-[2rem] border border-slate-200 bg-white">
                <div className="bg-gradient-to-r from-violet-600 to-indigo-600 px-5 pb-5 pt-10 text-white">
                  <div className="flex items-start justify-between gap-4">
                    <div>
                      ...
                      <h3 className="mt-1 text-xl font-bold">Maiz Kitchen</h3>
                      <p className="mt-1 text-xs text-white/80">
                        Homemade food • Order terus WhatsApp
                      </p>
                    </div>
                ...
                <div className="space-y-4 p-4">
                  ...
                  <div className="rounded-2xl border border-slate-200 p-3 shadow-sm">
                    ...
                    <div className="flex items-start justify-between gap-3">
                      <div>
                        <p className="font-semibold text-slate-900">Teh Ais</p>
                        <p className="mt-1 text-sm text-slate-500">
                          Sejuk & fresh
                        </p>
                      </div>
                  ...
                  <button className="mt-2 inline-flex w-full items-center justify-center gap-2 rounded-2xl bg-green-500 px-4 py-3.5 text-sm font-semibold text-white transition hover:bg-green-600">
                    <WhatsAppIcon />
                    Order via WhatsApp
                  </button>
