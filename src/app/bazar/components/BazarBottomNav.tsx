  ...
  return (
    <nav className="fixed inset-x-0 bottom-0 z-40 px-0 pb-0 pt-0 md:px-2 md:py-2">
      <div className="mx-auto grid w-full max-w-md grid-cols-5 gap-1 rounded-none border-t border-slate-200 bg-white/95 p-1 text-[10px] font-semibold text-slate-600 shadow-lg backdrop-blur md:max-w-lg md:rounded-2xl md:border md:p-1">
        <Link href="/bazar" className={`flex flex-col items-center rounded-xl px-2 py-1 ${pathname === '/bazar' ? 'bg-[#2563EB] text-white shadow-sm' : ''}`}>
        ...
        <Link href="/bazar" className={`flex flex-col items-center rounded-xl px-2 py-1 ${pathname === '/bazar' ? 'bg-[#2563EB] text-white shadow-sm' : ''}`}>
          <img src="/Home-Logo-BazarLink.svg" alt="Home BazarLink" className="h-6 w-6" />
          <span>Home</span>
        </Link>
        ...
        <Link href="/bazar/seller" className={`flex flex-col items-center rounded-xl px-2 py-1 ${pathname === '/bazar/seller' ? 'bg-[#2563EB] text-white shadow-sm' : ''}`}>
